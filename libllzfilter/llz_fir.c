 ...
 */
unsigned long llz_fir_filter_lpf_init(int frame_len, 
...
unsigned long llz_fir_filter_hpf_init(int frame_len, 
                                 int flt_len, double fc, win_t win_type)
{   
    llz_fir_filter_t *flt = NULL;
...
unsigned long llz_fir_filter_bandpass_init(int frame_len, 
...
unsigned long llz_fir_filter_bandstop_init(int frame_len, 
                                      int flt_len, double fc1, double fc2, win_t win_type)
{   
    llz_fir_filter_t *flt = NULL;
...
void llz_fir_filter_uninit(unsigned long handle)
{
...
int llz_fir_filter(unsigned long handle, double *buf_in, double *buf_out, int frame_len)
{
	int i;
    llz_fir_filter_t *flt = (llz_fir_filter_t *)handle;
 ...
 */
int llz_fir_filter_flush(unsigned long handle, double *buf_out)
{
	int i;
    llz_fir_filter_t *flt = (llz_fir_filter_t *)handle;
